# acpx@0.12.0 Contract Fixtures

Captured: 2026-07-06T06:52:45.935686+00:00
...
- `permission-denied-codex-read`: exit `5` expected `5`, stdout lines `18`.
...
- Session name: `s1a-session-contract`
- Scope: contract evidence only; runtime support lives in source code.
- `session-new-named`: exit `0` expected `0`, stdout lines `1`.
- `session-ensure-existing`: exit `0` expected `0`, stdout lines `1`.
- `session-show-open`: exit `0` expected `0`, stdout lines `1`.
- `session-prompt-turn1`: exit `0` expected `0`, stdout lines `19`.
- `session-prompt-turn2`: exit `0` expected `0`, stdout lines `12`.
- `session-show-after-turns`: exit `0` expected `0`, stdout lines `1`.
- `session-history-after-turns`: exit `0` expected `0`, stdout lines `1`.

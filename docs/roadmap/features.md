...
| F-ARSD-001 | local UDS production ingress, ownership, reconciliation, cgroup containment | Required | Planned | PRD R6/R10; A1 + PR #74 merged; A2–A4 closed; A4 S1–S5 on CPython 3.12.3 (operator-held evidence) | A5 production/default-on enablement — approved and in progress, not yet enabled; runtime invariant CPython 3.12.3 |

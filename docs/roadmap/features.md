...
| Session reuse under history replay | 0 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
...
One row is `Implemented`: F-SESSION-REPLAY-BACKPRESSURE-001 exists on a task branch and is not merged.
F-LONG-RUN-TIMEOUT-001 and F-CURSOR-GRANT-MODE-001 are merged on `main`.

...
| F-NATIVE-ADAPTER-CLAUDE-001 | Claude official ACP adapter closed profile: frozen runtime identity, enforced `default` permission mode, frozen session metadata on new+load | Required | Planned | PRD R1/R3/R7/R12; [active plan](../plans/active/2026-07-25-claude-official-adapter-b3-b5-closure.md) | independent review + real-credential acceptance, then publication/deployment/enablement — each separately approved |
...
| Registered official adapters | 0 | 2 | 0 | 0 |

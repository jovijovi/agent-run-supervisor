...
No row is `Implemented`. One row is `In review`: F-RUN-EVENT-BUDGET-CONFIG-001 is a feature-branch
candidate in pre-integration review, so it is not on `main`, and nothing about it is released or
deployed. F-OMP-REASONIX-SOURCE-001,
